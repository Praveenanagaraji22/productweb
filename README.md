    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by Praveena Nagaraji</footer></div>
            </div>
        </div>
    </body>
</html>
            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li><b>Email Id:</b>Pravee@fancyuniv.com</li>
                    </ul>
...
<html lang="en">
    <head>
        ...
        .manph1{
            background-image: url(/static/images/sanju.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/atchu.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Praveena</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Sanjitha</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Atchaya</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Vishnupriya</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Lakshmipriya</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Subalakshmi</h2></b></p></div><br>
